...
--
-- Host: localhost    Database: truresponse
-- ------------------------------------------------------
...
CREATE TABLE `account` (
  ...
  `identity_secret` varchar(45) DEFAULT NULL,
...
CREATE TABLE `user` (
  ...
  UNIQUE KEY `user_id_unique` (`unique_id`),
  UNIQUE KEY `reset_password_token_unique` (`reset_password_token`),
...
CREATE TABLE `user_token` (
  ...
  `agent` text,
  `last_accessed_on` date DEFAULT NULL,
  `status` varchar(45) DEFAULT NULL,
  `created_at` datetime NOT NULL,
  `updated_at` datetime NOT NULL,
  `deleted_at` datetime DEFAULT NULL,
...
--
-- Dumping events for database 'truresponse'
--

--
-- Dumping routines for database 'truresponse'
--
...
-- Dump completed on 2020-09-21 19:13:00
